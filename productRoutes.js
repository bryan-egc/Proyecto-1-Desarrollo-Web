...
const { getCatalog, getProduct, createOrUpdateProduct, deleteProduct } = require('./productController');
...
router.post('/Producto/', verifyToken, verifyAdmin, createOrUpdateProduct);
